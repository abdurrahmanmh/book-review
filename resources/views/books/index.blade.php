...
@section('content')
    <h1 class="mb-10 text-2xl">Book Review👏👏👏</h1>

    <form action="{{ route('books.index') }}" method="GET" class="mb-4 flex items-center space-x-2">
        <input type="text" name="title" id="" placeholder="Search by title" value="{{ request('title') }}"
            class="input h-10" />
                    ...
                    <div class="flex flex-wrap items-center justify-between">
                        ...
                        <div>
                            <div class="book-rating">
                                ...
                                <x-star-rating :rating='$book->reviews_avg_rating'></x->
                            </div>
